              ...
              <AnimatePresence mode="wait">
                {mode !== "success" ? (
                  ...
                  >
                    ...
                    {/* Mode Toggle */}
                    <div className="flex rounded-full border border-white/10 p-1 backdrop-blur-sm">
                      <button
                        type="button"
                        onClick={() => { if (mode !== "signin") switchMode(); }}
                    ...
                    <div className="space-y-4">
                      ...
                      <form onSubmit={handleAuthSubmit} className="space-y-3">
                        <input 
                          ...
                          className="w-full backdrop-blur-[1px] text-white border border-white/10 rounded-full py-3 px-5 focus:outline-none focus:border-white/30 bg-transparent placeholder-white/30"
                          required
                        />
                        <input 
                          type="password" 
                  ...
                  >
                    ...
                    <Link href="/dashboard" passHref>
                      <motion.button 
                        ...
                        animate={{ opacity: 1 }}
                        transition={{ delay: 1 }}
                        className="w-full rounded-full bg-white text-black font-medium py-3 hover:bg-white/90 transition-colors block"
                      >
